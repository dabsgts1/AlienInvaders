...
SHIP_LIVES    = 3
# The distance of the middle of the ship from the left of the screen
SHIP_LEFT     = ALIEN_H_SEP + SHIP_WIDTH / 2
#The distance of the middle of the ship from the right of the screen
SHIP_RIGHT    = GAME_WIDTH - ALIEN_H_SEP - SHIP_WIDTH / 2
# the distance of the middle of the ship from the defense line
SHIP_TOP      = DEFENSE_LINE - SHIP_BOTTOM
# the ship sprite image
...
STATE_COMPLETE = 5
# state when the user has paused the gameplay
STATE_USER_PAUSED = 6


### CONSTANTS FOR TEXT ###
# the x coordinate for the message lives
LIVES_TEXT_X = GAME_WIDTH - 80
# the y coordinate for the message lives
LIVES_TEXT_Y = GAME_HEIGHT - 30
# the x coordinate for the player score
PSCORE_LEFT = 15
# the y coordinate for the player score
PSCORE_Y = GAME_HEIGHT - 30
